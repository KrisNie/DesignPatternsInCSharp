...
namespace AbstractFactory.Pizza
{
    public class ClamPizza : AbstractPizza
    {
        ...
        internal override void Prepare()
        {
            ...
            Console.Write("Dough: " + _ingredients.CreateDough().Name + ", Clam: " + _ingredients.CreateClam().Name +
                          ", Sauce: " + _ingredients.CreateSauce().Name + ", Cheese: " +
                          _ingredients.CreateCheese().Name);
            Console.WriteLine();
        }
    }
}